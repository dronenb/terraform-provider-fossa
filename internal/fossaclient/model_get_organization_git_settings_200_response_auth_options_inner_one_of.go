...
// checks if the GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf{}

// GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf struct for GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf
type GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf struct {
...
func NewGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf() *GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf {
	this := GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf{}
	return &this
}
...
func (o GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) MarshalJSON() ([]byte, error) {
...
func (o GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf struct {
	value *GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf
	isSet bool
}

func (v NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) Get() *GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf {
	return v.value
}

func (v *NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) Set(val *GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf(val *GetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) *NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf {
	return &NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf{value: val, isSet: true}
}

func (v NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationGitSettings200ResponseAuthOptionsInnerOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
