...
// checks if the GetOrganizationCustomLicenseScanSettings200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganizationCustomLicenseScanSettings200ResponseInner{}

// GetOrganizationCustomLicenseScanSettings200ResponseInner struct for GetOrganizationCustomLicenseScanSettings200ResponseInner
type GetOrganizationCustomLicenseScanSettings200ResponseInner struct {
...
func NewGetOrganizationCustomLicenseScanSettings200ResponseInner() *GetOrganizationCustomLicenseScanSettings200ResponseInner {
	this := GetOrganizationCustomLicenseScanSettings200ResponseInner{}
	return &this
}
...
func (o GetOrganizationCustomLicenseScanSettings200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetOrganizationCustomLicenseScanSettings200ResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrganizationCustomLicenseScanSettings200ResponseInner struct {
	value *GetOrganizationCustomLicenseScanSettings200ResponseInner
	isSet bool
}

func (v NullableGetOrganizationCustomLicenseScanSettings200ResponseInner) Get() *GetOrganizationCustomLicenseScanSettings200ResponseInner {
	return v.value
}

func (v *NullableGetOrganizationCustomLicenseScanSettings200ResponseInner) Set(val *GetOrganizationCustomLicenseScanSettings200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationCustomLicenseScanSettings200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationCustomLicenseScanSettings200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationCustomLicenseScanSettings200ResponseInner(val *GetOrganizationCustomLicenseScanSettings200ResponseInner) *NullableGetOrganizationCustomLicenseScanSettings200ResponseInner {
	return &NullableGetOrganizationCustomLicenseScanSettings200ResponseInner{value: val, isSet: true}
}

func (v NullableGetOrganizationCustomLicenseScanSettings200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationCustomLicenseScanSettings200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
