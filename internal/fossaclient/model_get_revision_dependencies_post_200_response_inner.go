...
// checks if the GetRevisionDependenciesPost200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRevisionDependenciesPost200ResponseInner{}

// GetRevisionDependenciesPost200ResponseInner struct for GetRevisionDependenciesPost200ResponseInner
type GetRevisionDependenciesPost200ResponseInner struct {
	...
	Project *GetRevisionDependenciesPost200ResponseInnerProject `json:"project,omitempty"`
...
func NewGetRevisionDependenciesPost200ResponseInner() *GetRevisionDependenciesPost200ResponseInner {
	this := GetRevisionDependenciesPost200ResponseInner{}
	return &this
}
...
func (o *GetRevisionDependenciesPost200ResponseInner) GetProject() GetRevisionDependenciesPost200ResponseInnerProject {
	if o == nil || IsNil(o.Project) {
		var ret GetRevisionDependenciesPost200ResponseInnerProject
		return ret
	}
	return *o.Project
}
...
// SetProject gets a reference to the given GetRevisionDependenciesPost200ResponseInnerProject and assigns it to the Project field.
...
func (o GetRevisionDependenciesPost200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetRevisionDependenciesPost200ResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRevisionDependenciesPost200ResponseInner struct {
	value *GetRevisionDependenciesPost200ResponseInner
	isSet bool
}

func (v NullableGetRevisionDependenciesPost200ResponseInner) Get() *GetRevisionDependenciesPost200ResponseInner {
	return v.value
}

func (v *NullableGetRevisionDependenciesPost200ResponseInner) Set(val *GetRevisionDependenciesPost200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRevisionDependenciesPost200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRevisionDependenciesPost200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRevisionDependenciesPost200ResponseInner(val *GetRevisionDependenciesPost200ResponseInner) *NullableGetRevisionDependenciesPost200ResponseInner {
	return &NullableGetRevisionDependenciesPost200ResponseInner{value: val, isSet: true}
}

func (v NullableGetRevisionDependenciesPost200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRevisionDependenciesPost200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
