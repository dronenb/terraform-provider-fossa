...
// APIClient manages communication with the FOSSA API API v4.34.81
...
type APIClient struct {
	...
	CustomRiskScoresAPI CustomRiskScoresAPI

	DependenciesAPI DependenciesAPI

	IssueFiltersAPI IssueFiltersAPI

	IssueOverviewAPI IssueOverviewAPI

	IssuesAPI IssuesAPI

	JiraIntegrationSettingsAPI JiraIntegrationSettingsAPI

	LicenseConclusionsAPI LicenseConclusionsAPI

	OIDCAPI OIDCAPI

	OrganizationLabelsAPI OrganizationLabelsAPI

	OrganizationLimitsAPI OrganizationLimitsAPI

	OrganizationSettingsAPI OrganizationSettingsAPI

	PackageLabelsAPI PackageLabelsAPI

	PackageObservabilityAPI PackageObservabilityAPI

	ProjectLabelsAPI ProjectLabelsAPI

	ProjectsAPI ProjectsAPI

	ReleaseGroupsAPI ReleaseGroupsAPI

	ReportOptionsAPI ReportOptionsAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PackageLabelsAPI = (*PackageLabelsAPIService)(&c.common)
	c.PackageObservabilityAPI = (*PackageObservabilityAPIService)(&c.common)
